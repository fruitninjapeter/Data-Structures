...
class TestList(unittest.TestCase):
    ...
    def test_empty(self):
        ...
        self.assertTrue(compare_files("empty_out.txt", "empty_out_soln.txt"))

    def test_oneuniquechar(self):
        huffman_encode("qspam.txt", "qspam_out.txt")
        self.assertTrue(compare_files("qspam_out.txt", "qspam_out_soln.txt"))
